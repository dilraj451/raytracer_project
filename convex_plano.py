"""
A script that defines a plano-convex lens with the planar surface facing the 
...
variable diameter (set to 10 mm) is defined and propagated through the lens.
The RMS spot radius of the ray bundle is calculated and printed.
...
convex = oe.SphericalRefraction(100.0,1.0,1.5168,50.0,100.0)
plano = oe.SphericalRefraction(105.0,1.5168,1.0,np.Infinity,100.0)
